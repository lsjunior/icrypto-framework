...
public class MandatedPdfSigDicEntries extends ASN1Object {

  private final ASN1Sequence sequence;

  public MandatedPdfSigDicEntries(final ASN1Sequence sequence) {
    super();
  ...
  public static MandatedPdfSigDicEntries getInstance(final Object obj) {
    if ((obj == null) || (obj instanceof MandatedPdfSigDicEntries)) {
      return (MandatedPdfSigDicEntries) obj;
    }
    if (obj instanceof ASN1Sequence) {
      ...
      return new MandatedPdfSigDicEntries(sequence);
    }

    if (obj instanceof byte[]) {
      try {
        Object tmp = ASN1Primitive.fromByteArray((byte[]) obj);
        return MandatedPdfSigDicEntries.getInstance(tmp);
      } catch (Exception e) {
